use crate::{
    models::{Crate, NewCrate, NewRustacean, Rustacean},
...
impl RustaceanRepository {
    ...
    pub fn find_many(c: &mut PgConnection, limit: i64) -> QueryResult<Vec<Rustacean>> {
...
impl CrateRepository {
    ...
    pub fn find_many(c: &mut PgConnection, limit: i64) -> QueryResult<Vec<Crate>> {
